...
<center><iframe src="https://giphy.com/embed/3ohzdTQaODeGPt90uk" width="480" height="287" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/lamala-roc-nation-victoria-ortiz-3ohzdTQaODeGPt90uk">via GIPHY</a></p></center>
...
8. Use tools .grey[(which we'll talk about momentarily)] to help automate many of the steps, and make the whole thing less painful
...
.footnote[For a really quick but really good intro, see [Hilary Parker's](https://hilaryparker.com/2014/04/29/writing-an-r-package-from-scratch/comment-page-2/) blog post]
...
* The function **depends on** the [{tibble}](https://www.tidyverse.org/articles/2018/01/tibble-1-4-2/) package. 
...
* Why write tests?
  + If you write a new function, and breaks an old one, that's good to know! 
...
<iframe src="https://giphy.com/embed/GXrdixoDLFlL2" width="600" height="380" frameBorder="0" class="giphy-embed" allowFullScreen></iframe><p><a href="https://giphy.com/gifs/upvote-f5-GXrdixoDLFlL2">via GIPHY</a></p>
